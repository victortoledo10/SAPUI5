		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo",
									"targetURL": "#esvictorsapui5cero-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esvictorsapui5cero-display": {
								"semanticObject": "esvictorsapui5cero",
								"action": "display",
								"description": "Demo",
								"title": "Demo",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=es.victor.sapui5cero",
									"url": sap.ui.require.toUrl("es/victor/sapui5cero")
								}
							}
						}
					}
